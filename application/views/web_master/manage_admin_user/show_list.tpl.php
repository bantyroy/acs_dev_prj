...
<div class="col-md-8 col-md-offset-2">
       ...
       <div class="row">
		   <div class="col-md-5">
				   ...
				   <label><?php echo addslashes(t("Admin User Name"))?></label>
                  
                        	<input type="text" name="s_customer_name" id="s_customer_name" value="<?php echo $s_customer_name?>" class="form-control" />
							</div>
              </div>   
