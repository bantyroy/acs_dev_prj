...
<div id="content" class="span10">
			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<h1><?php echo addslashes(t("isubTech"))?> <small></small></h1>
						<p>isubtech.com is to become the premier online marketplace for the electronic products design and manufacturing industry. The all-ecompassing marketplace automatically
						matches company buyers and enterprenuers to industry professionals and manufacturers from around the globe with the right equipment, expertise and capasity at the right moment of time, creating efficiency and value.</p>
			...
			<div class="row-fluid sortable">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i>  <?php echo addslashes(t("New Customer"))?></h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo addslashes(t("New Supplier"))?></h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo addslashes(t("New Admin User"))?></h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
